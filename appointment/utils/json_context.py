...
def convert_appointment_to_json(request, appointments: list) -> list:
    ...
    return [{
        "id": appt.id,
        "client": appt.client.username if (appt.client and username_in_user_model()) else "",
        # "client": appt.client.username if appt.client and username_in_user_model() else "Unknown",
